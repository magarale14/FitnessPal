...
public class Fitness {
	...
	public static void main(String args[]){
		...
		Person Tom = new Person("Tom",'H',152.5,5,6); //Person (String firstName, Char lastNameInitial, double weight, int feet, int inches)
	   ...
	   System.out.println(Tom.getFirstName() +": "  + Tom.calculatBMI());
